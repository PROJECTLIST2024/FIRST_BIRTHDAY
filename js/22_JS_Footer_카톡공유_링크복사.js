...
kakaoShare.addEventListener('click',function(){
    ...
    Kakao.Share.sendDefault({
        ...
        content: {
          ...
          link: {
            mobileWebUrl: `intent:${window.location.origin}/FIRST_BIRTHDAY/;package=com.android.chrome;end`,
            webUrl: `intent:${window.location.origin}/FIRST_BIRTHDAY/;package=com.android.chrome;end`,  
          },
        },
